...
import reactionRoutes from "../src/routes/reaction.route";
import conversationRoutes from "../src/routes/conversation.route";
...
app.use(cors({ origin: ["http://localhost:3000" , "https://quickcollab-ten.vercel.app"], credentials: true }));
